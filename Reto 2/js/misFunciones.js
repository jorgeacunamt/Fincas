...
function eliminarFinca(idFinca) {
    ...
    $.ajax({
        url: 'https://gd65ba8a351ee01-db202109261448.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/farm/farm',
        type: "delete",
        data: dataToSend,
...
function eliminarCliente(idCliente) {
    ...
    let dataToSend = JSON.stringify(mydata);
    $.ajax({
        url: 'https://gd65ba8a351ee01-db202109261448.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client',
        type: "delete",
        data: dataToSend,
        contentType: "application/JSON",
        dataType: 'json',
...
function eliminarMensaje(idMensaje) {
    ...
    let dataToSend = JSON.stringify(mydata);
    $.ajax({
        url: 'https://gd65ba8a351ee01-db202109261448.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/message/message',
        type: "delete",
        data: dataToSend,
        contentType: "application/JSON",
        dataType: 'json',
